...
class GBPPage extends StatefulWidget {
  const GBPPage({Key? key}) : super(key: key);

  @override
  State<GBPPage> createState() => _LoginPageState();
}

class _LoginPageState extends State<GBPPage> {
  var _feedbackText = '';
  ...
  void _handleclick(int i){
    ...
    switch(i){
      case 1:
        setState(() {
          _feedbackText = "$temp บาทเท่ากับ ${MyConverter.B2GBP(temp)}ปอนด์สเตอร์ลิง";
        });
        break;
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          ...
          title: Text('แปลงสกุลเงินปอนด์สเตอร์ลิง')),
      body: Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.spaceEvenly,
          children: [
            Text('แปลงจากสกุลเงินบาทเป็นสกุลเงินปอนด์สเตอร์ลิง',style: TextStyle(fontSize: 40)),
            Row(
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      _buildButton("แปลงเป็นเงินปอนด์สเตอร์ลิง",1),
                    ],
                  ),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Text('อัตราแลกเปลี่ยน 1 บาท = 0.027 ปอนด์สเตอร์ลิง',style: TextStyle(fontSize: 30),)
                    ],
                  ),
                ],
              ),
