...
class JapanPage extends StatefulWidget {
  ...
  @override
  State<JapanPage> createState() => _LoginPageState();
}

class _LoginPageState extends State<JapanPage> {
  var _feedbackText = '';
  ...
  void _handleclick(int i){
    ...
    switch(i){
      case 1:
        setState(() {
          _feedbackText = "$temp บาทเท่ากับ ${MyConverter.B2Y(temp)}เยน";
        });
        break;
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          ...
          title: Text('แปลงสกุลเงินเยน')),
      body: Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.spaceEvenly,
          children: [
            Text('แปลงจากสกุลเงินบาทเป็นสกุลเงินเยน',style: TextStyle(fontSize: 40)),
            Row(
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      _buildButton("แปลงเป็นเงินเยน",1),
                    ],
                  ),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Text('อัตราแลกเปลี่ยน 1 บาท = 3.8589 เยน',style: TextStyle(fontSize: 30),)
                    ],
                  ),
                ],
              ),
